...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($név === '') {
        ...
        if ($link_szervezo) {
            redirect(BASE_URL . '/organizers/megtekint.php?id=' . $link_szervezo . '#kontaktok');
        }
        redirect(BASE_URL . '/contacts/megtekint.php?id=' . $kid);
    }
...
<div class="card">
    ...
    <form method="post">
        ...
        <div class="form-actions">
            ...
            <a href="<?= h($szervezo_id ? BASE_URL . '/organizers/megtekint.php?id=' . $szervezo_id : BASE_URL . '/contacts/') ?>" class="btn btn-secondary">Mégse</a>
        </div>
    </form>
</div>
