    ...
    return [
        'events_calendar_events' => [
            ...
            'columns' => [
                ...
                'finance_organizer_fee' => ['type' => 'decimal', 'nullable' => true, 'note' => 'Fizetendő összeg (Ft)'],
                'finance_amount_paid' => ['type' => 'decimal', 'nullable' => true, 'note' => 'Ténylegesen fizetett összeg (Ft)'],
