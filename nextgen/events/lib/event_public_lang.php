...
function events_public_megjelenit_strings(string $lang): array {
    $hu = [
        ...
        'external_info_disclaimer' => 'A Latinfo.hu nem vállal felelősséget az itt közzétett információkért; azokat minden esetben az esemény oldalán találhatjátok meg!',
    ...
    $en = [
        ...
        'external_info_notice_suffix' => '!',
        'external_info_disclaimer' => 'Latinfo.hu accepts no responsibility for the information published here; always verify details on the event page!',
