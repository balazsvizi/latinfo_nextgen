...
function events_public_home_strings(string $lang): array {
    $hu = [
        ...
        'map_no_coords_hint' => '%d eseménynek nincs GPS koordinátája a helyszínen.',
        'map_empty' => 'Nincs megjeleníthető esemény koordinátával a jelenlegi szűréshez.',
        'list_display_label' => 'Megjelenítve:',
        'list_display_all' => 'Mind',
    ...
    $en = [
        ...
        'map_no_coords_hint' => '%d events have no GPS coordinates on the venue.',
        'map_empty' => 'No events with coordinates match the current filters.',
        'list_display_label' => 'Showing:',
        'list_display_all' => 'All',
        'list_heading' => 'Events',
