...
function events_public_home_strings(string $lang): array {
    $hu = [
        ...
        'renewal_notice_prefix' => 'Megújult a Latinfo.hu naptár! Neked hogy tetszik?',
        'renewal_notice_link' => 'Írd meg nekünk!',
    ...
    $en = [
        ...
        'renewal_notice_prefix' => 'The Latinfo.hu calendar has been renewed! How do you like it?',
        'renewal_notice_link' => 'Tell us!',
