...
function events_public_megjelenit_strings(string $lang): array {
    $hu = [
        ...
        'external_info_notice_prefix' => 'Részletes és aktuális információk ',
        'external_info_notice_link' => 'az esemény oldalán',
        'external_info_notice_suffix' => ' találhatók!',
    ...
    $en = [
        ...
        'external_info_notice_prefix' => 'Detailed and up-to-date information is available ',
