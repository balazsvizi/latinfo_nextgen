...
function events_notify_email_set_default_smtp_id(PDO $db, int $smtpId): void
{
    events_notify_email_setting_set($db, EVENTS_NOTIFY_EMAIL_SETTING_SMTP_ID, (string) max(0, $smtpId));
}
...
/**
 * Tracking pixel megnyitás rögzítése.
 */
