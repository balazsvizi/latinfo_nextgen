...
$previewHumanMedia = (int) ($statsData['totals']['calendar_previews_human'] ?? $statsData['totals']['calendar_previews'] ?? 0);
...
<div class="card events-edit-stats events-edit-stats--organizer">
    ...
    <p class="events-edit-stats__intro">A szervező összes eseményére vonatkozó naptár előnézet, további információ kattintás és oldalmegtekintés az időszakban.</p>
            ...
            <table class="sortable-table events-admin-table events-edit-stats__events-table">
                <thead>
                    <tr>
                        ...
                        <th class="th-center" title="További információ gombra kattintás">Tov. info</th>
                        ...
                        <th class="th-center" title="Előnézet (ember) × <?= (int) $statsPreviewUnitFt ?> Ft">Előnézet Ft</th>
                ...
                <tbody id="organizer-stats-events-tbody">
                    <?php foreach ($statsEventRows as $row): ?>
                        ...
                        >
                            ...
                            <td class="text-center"><?= $externalClicks ?></td>
                    ...
                    <tr id="organizer-stats-events-empty" hidden>
                        <td colspan="13" class="events-org-stats-list-empty">Nincs találat a szűrőkre.</td>
                    </tr>
                </tbody>
            </table>
        </div>
