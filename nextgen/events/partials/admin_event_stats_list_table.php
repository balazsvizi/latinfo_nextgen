        ...
        <table class="sortable-table events-admin-table events-admin-table--stats">
            <thead>
                <tr class="events-stats-thead-primary">
                    ...
                    <th class="events-stats-th-group events-stats-th-group--media" colspan="3" scope="colgroup">Médiaérték</th>
                ...
                <tr class="events-stats-thead-secondary">
                    ...
                    <th class="th-center events-stats-th-sub events-stats-th-sub--media" title="Előnézet (ember) × egységár"><?= sort_th('Előnézet Ft', 'media_preview', $order, $dir_param, $get_params) ?></th>
