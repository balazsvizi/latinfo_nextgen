...
<div class="events-cal-view-switch-row">
    <nav class="events-cal-view-switch events-cal-view-switch--standalone" aria-label="Nézet választó">
        ...
        <?php endif; ?>
        <?php if ($activeView === 'map'): ?>
            <span class="events-cal-view-switch__item is-active" aria-current="page">Térkép</span>
        <?php else: ?>
            <a class="events-cal-view-switch__item" href="<?= h($mapViewUrl) ?>">Térkép</a>
        <?php endif; ?>
    </nav>
    <?php if ($activeView === 'list'): ?>
