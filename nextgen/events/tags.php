                    ...
                    <td colspan="<?= $tagBulkTypesEnabled ? 4 : 3 ?>">
                        <div class="events-tags-admin__form-panel events-tags-admin__form-panel--inline">
                            <form method="post" action="<?= h(events_url('tags.php')) ?>">
                                ...
                                require __DIR__ . '/partials/tags_types_fieldset.php';
                                ?>
                                <p class="help">Új DJ-t a <a href="<?= h(events_url('dj_letrehoz.php')) ?>">DJ-k → Új DJ</a> oldalon hozz létre (fotófeltöltéssel).</p>
                                <div class="toolbar">
                        ...
                        <td colspan="<?= $tagBulkTypesEnabled ? 4 : 3 ?>">
                            <div class="events-tags-admin__form-panel events-tags-admin__form-panel--inline">
                                <form method="post" action="<?= h(events_url('tags.php')) ?>">
                                    ...
                                    require __DIR__ . '/partials/tags_types_fieldset.php';
                                    if (in_array('dj', $typeCodesRow, true)):
                                    ?>
                                    <p class="help">
                                        DJ adatlap:
                                        <a href="<?= h(events_url('dj_szerkeszt.php?id=') . $tid) ?>">szerkesztés</a>
                                        (fotó, bio, elérhetőségek)
                                    </p>
                                    <?php endif; ?>
                                    <div class="toolbar">
                                        <button type="submit" class="btn btn-primary">Mentés</button>
