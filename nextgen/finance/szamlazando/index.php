        ...
        <table class="sortable-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>–</td>
                    <td class="actions">
                        <a href="<?= h(nextgen_url('finance/szamlak/letrehoz.php?szervezo_id=')) ?><?= (int)$s['szervező_id'] ?>&szamlazando_id=<?= (int)$s['id'] ?>" class="btn btn-primary btn-sm">Számlakészítés</a>
                        <a href="<?= h(nextgen_url('finance/szamlazando/szerkeszt.php?id=')) ?><?= (int)$s['id'] ?>" class="btn btn-secondary btn-sm">Szerkeszt</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($s['szamla_id']) && !empty($s['szamla_szam'])): ?>
                            <a href="<?= h(nextgen_url('finance/szamlak/szerkeszt.php?id=')) ?><?= (int)$s['szamla_id'] ?>&vissza=szamlazando"><?= h($s['szamla_szam']) ?></a>
