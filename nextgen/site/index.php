...
$dayEvents = latinfo_home_today_tomorrow_events($db, 5);
...
$heroTitle = $settings['hero_title'] !== '' ? $settings['hero_title'] : SITE_NAME;
$heroDek = $settings['hero_lead'];
$heroKicker = $settings['hero_kicker'];
$heroUrl = $settings['hero_cta_url'] !== '' ? $settings['hero_cta_url'] : $calendarUrl;
$heroCta = $settings['hero_cta_label'] !== '' ? $settings['hero_cta_label'] : $H['calendar'];
