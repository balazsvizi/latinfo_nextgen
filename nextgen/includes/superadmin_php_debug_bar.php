...
<script>
(function () {
    var bar = document.getElementById('ng-php-debug-bar');
    if (!bar || bar.dataset.ngCopyBound === '1') return;
    bar.dataset.ngCopyBound = '1';
    var btn = bar.querySelector('.ng-php-debug-copy');
