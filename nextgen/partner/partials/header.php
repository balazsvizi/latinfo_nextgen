...
<div class="partner-context-bar">
    <div class="partner-context-bar__inner">
        <label class="partner-context-bar__label" for="partner-context-select">Aktív profil</label>
        <div class="partner-context-bar__form">
            <select id="partner-context-select" class="partner-context-bar__select" aria-label="Profil váltása">
                <option value="all"<?= $partnerContext['key'] === 'all' ? ' selected' : '' ?>>Összes profil</option>
                <?php
                $orgOpts = array_filter($partnerContexts, static fn (array $c): bool => $c['type'] === 'organizer');
                $djOpts = array_filter($partnerContexts, static fn (array $c): bool => $c['type'] === 'dj');
                ?>
                <?php if ($orgOpts !== []): ?>
        ...
        <p class="partner-context-bar__hint">
            Most: <strong><?= h($partnerContext['label']) ?></strong>
            — az eseménylista és a statisztikák ehhez igazodnak.
        </p>
    </div>
</div>
<script>
