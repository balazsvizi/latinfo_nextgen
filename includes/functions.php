...
function log_entity_url(string $entitás, ?int $entitás_id): ?string {
    ...
    $urls = [
        'szervező' => '/organizers/megtekint.php?id=',
        'kontakt' => '/contacts/megtekint.php?id=',
        'számla' => '/finance/szamlak/szerkeszt.php?id=',
        'számlázandó' => '/finance/szamlazando/szerkeszt.php?id=',
        'számlázási_cím' => '/finance/cimek/szerkeszt.php?id=',
        'admin' => '/admin/adminok/szerkeszt.php?id=',
        'email_config' => '/admin/email/szerkeszt.php?id=',
        'levélsablon' => '/config/levelsablonok/szerkeszt.php?id=',
