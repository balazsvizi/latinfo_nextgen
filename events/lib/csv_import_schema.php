    ...
    return [
        'events_calendar_events' => [
            ...
            'columns' => [
                ...
                'event_start_date' => ['type' => 'date', 'nullable' => true],
                'event_start_time' => ['type' => 'time', 'nullable' => true],
                'event_end_date' => ['type' => 'date', 'nullable' => true],
                'event_end_time' => ['type' => 'time', 'nullable' => true],
