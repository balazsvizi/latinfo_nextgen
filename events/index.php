...
$listViewUrl = events_url('index.php?' . http_build_query($listViewParams));

$calViewParams = $filters['get_params'];
unset($calViewParams['view']);
$calViewParams['month'] = $monthKey;
$calViewUrl = events_url('index.php?' . http_build_query($calViewParams));

$filterFormAction = events_url('index.php');
...
$filterClearUrl = events_url('index.php?' . http_build_query($filterClearParams));
