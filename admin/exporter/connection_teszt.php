...
<div class="card card-narrow">
    ...
    <div class="form-actions">
        <a href="<?= h(BASE_URL) ?>/admin/exporter/connections.php" class="btn btn-primary">← Vissza a kapcsolatokhoz</a>
        <a href="<?= h(BASE_URL) ?>/admin/exporter/connection_szerkeszt.php?id=<?= (int)$row['id'] ?>" class="btn btn-secondary">Szerkeszt</a>
    </div>
</div>
