...
<div class="card">
    ...
    <div class="form-actions" style="margin-bottom: 1rem;">
        <a href="<?= h(BASE_URL) ?>/admin/exporter/" class="btn btn-secondary">← SQL export</a>
        <a href="<?= h(BASE_URL) ?>/admin/exporter/connection_letrehoz.php" class="btn btn-primary">Új kapcsolat</a>
    </div>
    <div class="table-wrap">
        <table class="sortable-table">
            ...
            <tbody>
                <?php if (empty($listak)): ?>
                <tr><td colspan="6">Még nincs mentett kapcsolat. <a href="<?= h(BASE_URL) ?>/admin/exporter/connection_letrehoz.php">Új kapcsolat hozzáadása</a></td></tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <a href="<?= h(BASE_URL) ?>/admin/exporter/connection_teszt.php?id=<?= (int)$r['id'] ?>" class="btn btn-sm btn-primary">Teszt</a>
                        <a href="<?= h(BASE_URL) ?>/admin/exporter/connection_szerkeszt.php?id=<?= (int)$r['id'] ?>" class="btn btn-sm btn-secondary">Szerkeszt</a>
