...
<div class="card">
    ...
    <div class="form-actions" style="margin-bottom: 0.5rem;">
        <a href="<?= h(BASE_URL) ?>/admin/exporter/" class="btn btn-primary">Új lekérdezés</a>
        <a href="<?= h(BASE_URL) ?>/admin/exporter/connections.php" class="btn btn-secondary">Adatbázis kapcsolatok</a>
    </div>
    ...
    <div class="exporter-layout">
        <aside class="exporter-sidebar">
            ...
            <a href="<?= h(BASE_URL) ?>/admin/exporter/" class="btn btn-sm btn-primary" style="display:inline-block; margin-bottom: 0.5rem;">+ Új lekérdezés</a>
