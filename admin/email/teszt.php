    ...
    <form method="post" id="email-teszt-form">
        ...
        <div class="form-group">
            ...
            <?php if ($admin_email === '' && $admin_id > 0): ?>
                <p class="text-muted" style="margin:0.35rem 0 0; font-size:0.875rem;">Nincs e-mail a profilodon – írj be címet, vagy <a href="<?= h(BASE_URL) ?>/admin/adminok/szerkeszt.php?id=<?= (int) $admin_id ?>">add meg az admin adatlapodon</a> a későbbi előtöltéshez.</p>
            <?php endif; ?>
        </div>
