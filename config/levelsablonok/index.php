...
<div class="card">
    ...
    <form method="get" class="toolbar">
        ...
        <a href="<?= h(BASE_URL) ?>/config/levelsablonok/letrehoz.php" class="btn btn-primary">Új levélsablon</a>
    </form>
        ...
        <table class="sortable-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <a href="<?= h(BASE_URL) ?>/config/levelsablonok/szerkeszt.php?id=<?= (int)$s['id'] ?>" class="btn btn-sm btn-secondary">Szerkeszt</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
