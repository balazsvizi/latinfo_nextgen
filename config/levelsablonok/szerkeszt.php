...
if ($id <= 0) {
    ...
    redirect(BASE_URL . '/config/levelsablonok/');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nev === '' || $kod === '' || $targy === '' || $html === '') {
        ...
        try {
            ...
            redirect(BASE_URL . '/config/levelsablonok/szerkeszt.php?id=' . $id);
...
<div class="card">
    ...
    <form method="post">
        ...
        <div class="form-actions">
            ...
            <a href="<?= h(BASE_URL) ?>/config/levelsablonok/" class="btn btn-secondary">Vissza</a>
        </div>
    </form>
</div>
<div class="card">
