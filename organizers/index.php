...
<div class="card">
    ...
    <form method="get" class="toolbar">
        ...
        <a href="<?= h(BASE_URL) ?>/organizers/letrehoz.php" class="btn btn-primary">Új szervező</a>
    </form>
    ...
    <div class="table-wrap">
        <table class="sortable-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><?= (int)$s['id'] ?></td>
                    <td><a href="<?= h(BASE_URL) ?>/organizers/megtekint.php?id=<?= (int)$s['id'] ?>"><?= h($s['név']) ?></a></td>
                    <td>
                    ...
                    <td class="actions">
                        <a href="<?= h(BASE_URL) ?>/organizers/megtekint.php?id=<?= (int)$s['id'] ?>" class="btn btn-sm btn-secondary">Megtekint</a>
                        <a href="<?= h(BASE_URL) ?>/organizers/szerkeszt.php?id=<?= (int)$s['id'] ?>" class="btn btn-sm btn-secondary">Szerkeszt</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
