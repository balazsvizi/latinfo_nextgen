...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($név === '') {
        ...
        try {
            ...
            redirect(BASE_URL . '/organizers/megtekint.php?id=' . $id);
        } catch (Exception $e) {
            $db->rollBack();
...
<div class="card">
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <p class="help"><a href="<?= h(BASE_URL) ?>/config/cimkek.php">Új címke felvétele</a></p>
        </div>
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">Mentés</button>
            <a href="<?= h(BASE_URL) ?>/organizers/megtekint.php?id=<?= $id ?>" class="btn btn-secondary">Mégse</a>
        </div>
    </form>
</div>
