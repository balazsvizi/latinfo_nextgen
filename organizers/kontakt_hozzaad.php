...
<div class="card">
    ...
    <p><a href="<?= h(BASE_URL) ?>/organizers/megtekint.php?id=<?= $szervezo_id ?>">← Vissza</a></p>
    ...
    <div class="kontakt-hozzaad-blokk kontakt-hozzaad-uj">
        ...
        <p><a href="<?= h(BASE_URL) ?>/contacts/letrehoz.php?szervezo_id=<?= $szervezo_id ?>" class="btn btn-primary">Új kontakt létrehozása</a></p>
    </div>

    <p style="margin-top:1rem;"><a href="<?= h(BASE_URL) ?>/organizers/megtekint.php?id=<?= $szervezo_id ?>" class="btn btn-secondary">Mégse</a></p>
</div>
